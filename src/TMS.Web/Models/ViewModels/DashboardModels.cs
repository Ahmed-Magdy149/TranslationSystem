...
public class DashboardModels
{
    ...
    {
        new() { Label = "Words This Month", Icon = "font-size", IconBg = "#dbeafe", IconColor = "#2563eb", Value = "42.6K", Percentage = 78, BarColor = "#1890ff" },
        new() { Label = "Productivity Score", Icon = "rise", IconBg = "#dcfce7", IconColor = "#16a34a", Value = "91%", Percentage = 91, BarColor = "#52c41a" },
        new() { Label = "QA Score", Icon = "safety-certificate", IconBg = "#f3e8ff", IconColor = "#9333ea", Value = "96.4%", Percentage = 96, BarColor = "#722ed1" },
        new() { Label = "On-Time Delivery", Icon = "carry-out", IconBg = "#fef3c7", IconColor = "#d97706", Value = "94%", Percentage = 94, BarColor = "#faad14" }
    };
